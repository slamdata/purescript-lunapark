module Lunapark.WebDriverError where
...
fromStringCode ∷ String → Either J.JsonDecodeError WebDriverErrorType
fromStringCode = case _ of
  ...
  s → Left $ J.Named "WebDriverErrorType" $ J.UnexpectedValue $ J.fromString s

toStringCode ∷ WebDriverErrorType → String
...
fromJson ∷ J.Json → Either J.JsonDecodeError WebDriverError
fromJson js = do
  obj ← J.decodeJson js
  value ← obj J..: "value"
